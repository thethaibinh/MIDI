...
// std::array<double, 3> --> geometry_msgs::msg::Point
...
// std::array<double, 3> --> geometry_msgs::msg::Vector3
inline void transform_body_to_camera(const std::array<double, 3>& body_point,
...
inline void transform_body_to_camera(
  const geometry_msgs::msg::Point& body_point, geometry_msgs::msg::Point& camera_point) {
...
inline void transform_body_to_camera(const geometry_msgs::msg::Vector3& body_vector,
                              geometry_msgs::msg::Vector3& camera_vector) {
...
// body frame (FLU) std::array<double, 3> --> geometry_msgs::msg::Point
...
// geometry_msgs::msg::Point --> geometry_msgs::msg::Point
inline void transform_camera_to_body(const geometry_msgs::msg::Point& camera_point,
                              geometry_msgs::msg::Point& body_point) {
...
// geometry_msgs::msg::Vector3 --> geometry_msgs::msg::Vector3
inline void transform_camera_to_body(const geometry_msgs::msg::Vector3& camera_vector,
                              geometry_msgs::msg::Vector3& body_vector) {
...
inline void transform_camera_to_body(const geometry_msgs::msg::Vector3& camera_point,
                              geometry_msgs::msg::Point& body_point) {
  body_point.x = camera_point.z;   // Forward remains Forward
  body_point.y = -camera_point.x;  // Right to Left
  body_point.z = -camera_point.y;  // Down to Up
...
inline void transform_camera_to_body(const geometry_msgs::msg::Point& camera_vector,
                              geometry_msgs::msg::Vector3& body_vector) {
  body_vector.x = camera_vector.z;   // Forward remains Forward
  body_vector.y = -camera_vector.x;  // Right to Left
  body_vector.z = -camera_vector.y;  // Down to Up
